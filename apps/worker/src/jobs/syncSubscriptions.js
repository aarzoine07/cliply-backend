...
async function logAuditEvent(workspaceId, subscriptionId, payload) {
...
async function upsertSubscription(workspaceId, sub, plan) {
    ...
    try {
        ...
        do {
            ...
            for (const sub of stripeSubs.data) {
                ...
                const workspaceId = typeof sub.metadata?.workspace_id === "string" && UUID_PATTERN.test(sub.metadata.workspace_id)
