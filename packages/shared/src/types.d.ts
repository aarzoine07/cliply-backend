...
export type JobKind = 'TRANSCRIBE' | 'HIGHLIGHT_DETECT' | 'CLIP_RENDER' | 'THUMBNAIL_GEN' | 'PUBLISH_YOUTUBE' | 'ANALYTICS_INGEST';
export type ProjectStatus = 'queued' | 'processing' | 'ready' | 'error';
export type ClipStatus = 'proposed' | 'approved' | 'rejected' | 'rendering' | 'ready' | 'published' | 'failed';
